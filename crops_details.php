...
$myid=$_GET['user_id'];
if ($myid !="") {
    $sql = "SELECT * FROM `tbl_crops` WHERE crop_id = '$myid'";
            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="single_left_bar">
                    <div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="">
                            <img src="images/plants/<?php echo $row['image'];?>" alt="News" class="img-responsive">
                        </div> <!-- End of .img_holder -->
                        <div class="post">

                            <div class="text">
                                <u><h4><a href="blog-details.html">About <?php echo $row['crop_name'];?> </a></h4></u>
