    ...
    <div class="container" style="margin-top: -70px">
                <div class="">
                    <ul class="nav nav-pills">
                        <li class="active"><a data-toggle="tab" href="#tropical">Tropical</a></li>
                        <li><a data-toggle="tab" href="#pomes">Pomes</a></li>
                        <li><a data-toggle="tab" href="#drupes">Drupes</a></li>
                        <li><a data-toggle="tab" href="#berries">Berries</a></li>
                        <li><a data-toggle="tab" href="#melons">Melons</a></li>
                        <li><a data-toggle="tab" href="#citrus">Citrus</a></li>
                    </ul>
                </div>

        <div class="tab-content">
            <div class="row  tab-pane fade in active " id="tropical">
                <?php
                $sql="SELECT *
            FROM
            ...
            <div class="row  tab-pane fade" id="pomes">
                <?php
                $sql="SELECT *
            FROM
                agriculture_database.tbl_crops
            ...
            <div class="row  tab-pane fade" id="drupes">
                <?php
                $sql="SELECT *
            FROM
                agriculture_database.tbl_crops
            ...
            <div class="row  tab-pane fade" id="berries">
                <?php
                $sql="SELECT *
            FROM
                agriculture_database.tbl_crops
            ...
            <div class="row  tab-pane fade" id="melons">
                <?php
                $sql="SELECT *
            FROM
                agriculture_database.tbl_crops
            ...
            <div class="row  tab-pane fade" id="citrus">
                <?php
                $sql="SELECT *
            FROM
                agriculture_database.tbl_crops
