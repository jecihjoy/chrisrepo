        ...
        <div class="row">
            ...
            FROM
                ...
                INNER JOIN agriculture_database.tbl_crop_category
                    ...
                    WHERE tbl_crop_category.cat_id = 5";
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; ">
                        <div class="img-holder">
                            <img src="images\veges\<?php echo $row['image']?>" style="height: 150px; width:380px ;" alt="News" class="img-responsive">
                        </div>
                        <!-- End of .img_holder -->
                        <div class="post">
                            <div class="text">
                                ...
                                <div class="link"><a href="crops_details.php?action = transview&user_id=<?php echo $row['crop_id']?>" class="tran3s" style="color: green;">READ MORE<span
